...
class Test_Login_001():    # Test_Login_001 : THIS IS IDENTIFIER

    #url='' --shift to conftest
    url=Readconfig.getApplicationURL()              #   url : THIS IS IDENTIFIER
    email=Readconfig.getUsermail()
    password=Readconfig.getPassword()
    Logger=LogGenerator.loggen()

    # @allure.title('nopcommerce_login')
    def testLoginPage(self,setup):     # testLoginPage : THIS IS IDENTIFIER
